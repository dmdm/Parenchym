System.register(['angular2/core', './messenger'], function(exports_1, context_1) {
    "use strict";
        ...
        execute: function() {
            NgbDropdown = (function () {
                ...
                NgbDropdown.prototype._addGlobalClickListener = function () {
                    ...
                    if (!this._removeGlobalClickListener) {
                        this._removeGlobalClickListener =
                            this._renderer.listenGlobal('document', 'click', function ($event) {
                ...
                NgbDropdown = __decorate([
                    ...
                    __metadata('design:paramtypes', [core_1.Renderer, (typeof (_a = typeof messenger_1.NgbGlobalMessenger !== 'undefined' && messenger_1.NgbGlobalMessenger) === 'function' && _a) || Object])
                ], NgbDropdown);
                return NgbDropdown;
                var _a;
            }());
