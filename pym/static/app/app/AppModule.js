...
var _MeModule = require('../parenchym/me/MeModule');

var _MeModule2 = _interopRequireDefault(_MeModule);
...
var _module = _angular2.default.module('app', [_GrowlerModule2.default.name, _ParenchymModule2.default.name, _TreeModule2.default.name, _StorageModule2.default.name, _DialogsModule2.default.name, _AuthMgrModule2.default.name, _MeModule2.default.name]).config(config).run(run).service('app.AppService', _AppService2.default.serviceFactory).controller('app.AppController', _AppController2.default).controller('FooController', _foo.FooController).directive('fooBar', _fooBarDirective.FooBarDirective.directiveFactory);
