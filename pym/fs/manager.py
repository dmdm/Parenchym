...
# def delete_fs_node(sess, fs_node, deleter, recursive=False,
#         deletion_reason=None, delete_from_db=False):
#     """
#     Deletes a FsNode.
#
#     :param sess: A DB session instance.
...
#     :param recursive: If True and node is not empty, deletes also all of node's
#         children.
...
#     """
#     fsn = FsNode.find(sess, fs_node)
#     if fsn.has_children() and not recursive:
#         raise OSError("FsNode not empty: {}".format(fs_node))
#     if delete_from_db:
#         sess.delete(fsn)
#         fsn = None
#     else:
...
#         # TODO Flag children if recursive is True
#     return fsn
