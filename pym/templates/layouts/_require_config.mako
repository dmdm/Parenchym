...
//        '${request.static_url('pym:static/app/app.min.js')}'
    ...
    , paths: {
        ...
        , 'pnotify.buttons': 'static-pym/bower_components/pnotify/pnotify.custom.min'
        , 'pnotify.history': 'static-pym/bower_components/pnotify/pnotify.custom.min'
        , 'pnotify.callbacks':'static-pym/bower_components/pnotify/pnotify.custom.min'
        , 'pnotify.confirm': 'static-pym/bower_components/pnotify/pnotify.custom.min'
